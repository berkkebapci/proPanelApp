...
class AydinlatmaMetni1 extends StatefulWidget {
  @override
  _AydinlatmaMetni1State createState() => _AydinlatmaMetni1State();
}

class _AydinlatmaMetni1State extends State<AydinlatmaMetni1> {
  @override
                      ...
                      child: RaisedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => GorusulecekKisi()),
                          );
                        },
                        child: Text("Okudum",
                            style: TextStyle(
